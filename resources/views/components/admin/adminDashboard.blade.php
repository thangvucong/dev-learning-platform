                ...
                <nav class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="space-y-1">
                            ...
                            <a href="{{ route('admin.classes.managerClasses') }}" class="flex items-center gap-3 px-3 py-2 text-slate-400 hover:bg-slate-800 hover:text-white rounded-lg transition-all">
                                Quản lý lớp học
                            </a>
                        </div>
                    </div>
